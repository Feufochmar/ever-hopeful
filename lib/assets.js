...
// Not in prototype, for renderer
Asset.urlForDisplay = function (name, proxyPath) {
...
Asset.prototype.urlForDisplay = function () {
  return Asset.urlForDisplay(this.wikiname, this.getProxyPath())
}
...
Asset.prototype.urlForNew = function () {
  var wname = encodeURIComponent(this.wikiname)
  var proxy = this.getProxyPath() || ''
  return proxy + '/assets/new/' + wname
}

Asset.prototype.urlForNewWithError = function () {
  var wname = encodeURIComponent(this.wikiname)
  var proxy = this.getProxyPath() || ''
  return proxy + '/assets/new/' + wname + '?e=1'
}

Asset.prototype.urlForRevert = function (version) {
  var wname = encodeURIComponent(this.wikiname)
  var proxy = this.getProxyPath() || ''
  return proxy + '/assets/revert/' + version + '/' + wname
}

Asset.prototype.urlForHistory = function () {
  var wname = encodeURIComponent(this.wikiname)
  var proxy = this.getProxyPath() || ''
  return proxy + '/assets/history/' + wname
}

Asset.prototype.urlForVersion = function (version) {
  var wname = encodeURIComponent(this.wikiname)
  var proxy = this.getProxyPath() || ''
  return proxy + '/assets/version/' + version + '/' + wname
}
